...
public class P02WorkWithStrings {
	 ...
	 * e 0 se iguais. A comparação deve ser feita primeiro em termos lexicográficos
	 * caracter a caracter começando pelos caracteres de menor peso ou em segundo
	 * lugar em termos de número de caracteres. Se diferentes deve devolver o índice
	 * +1/-1 do caractere que faz a diferença. Ex. s1="Bom", s2="Dia", deve devolver
	 * -1; s1="Boa", s2="Bom", deve devolver -3; s1="Bom", s2="Bo", deve devolver 3.
	 * Uma String a null é considerada menor que uma string não null.
	 * 
